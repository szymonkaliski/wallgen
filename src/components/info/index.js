...
const Info = () => <div>
  ...
  <p>
    Abstract wallpapers are initially generated at random, each <i>evolve</i> takes another evolution step, with selected wallpaper becoming the most <i>fit</i> one.
  </p>
  ...
  <p>
    Whole process takes place in your browser, nothing is persisted on the server, so once you close the tab, you will never see these wallpapers again.
  </p>
</div>;
