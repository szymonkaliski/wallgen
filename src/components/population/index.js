    ...
    return (
      <div>
                ...
                <div className="fl w-100 w-third-ns pa2" key={i}>
                  <div className="ba b--gray">
                    ...
                    <div className="bt flex items-center b--gray">
                      <div
                        className="pa2 f6 tc w-50 pointer bg-animate hover-white hover-bg-gray br b--gray"
                        onClick={() => this.onClickPhenotype(id)}
                      >
                        Evolve
                      </div>
                      <div
                        className="pa2 f6 tc w-50 pointer bg-animate hover-white hover-bg-gray"
                        onClick={() => this.downloadPhenotype(id)}
                      >
                        Download
                      </div>
                    </div>
        ...
        <div className="flex items-center justify-center pb3">
          <div
            className="w-120px pa2 tc b--gray pointer bg-animate hover-white hover-bg-gray ba border-box"
            onClick={() => this.onClickMoveOffset(-1)}
          >
            Previous
          </div>
          <div className="w-120px pa2 tc">
            {round(offset / DISPLAY_PER_PAGE) + 1} / {round(population.count() / DISPLAY_PER_PAGE)}
          </div>
          <div
            className="w-120px pa2 tc b--gray pointer bg-animate hover-white hover-bg-gray ba border-box"
            onClick={() => this.onClickMoveOffset(+1)}
